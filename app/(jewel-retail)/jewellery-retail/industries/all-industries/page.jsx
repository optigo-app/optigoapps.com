...
export const metadata = generatePageMetadata(pages['/jewellery-retail/industries/all-industries']);
...
const page = () => {
    return (
        <div>
            ...
            <div className="erp-retail-summary-container">
                <h1 className="erp-title">OptigoApps Jewellery Retail ERP</h1>
                <p className="erp-subtitle">A complete ERP suite designed for Boutique, Multi-Branch Retail, Retail Store, and Franchise jewellery retailers to manage every aspect of operations—faster, smarter, and more profitably.</p>
