...
export const metadata = generatePageMetadata(pages['/jewellery-retail/features/approval-memo-reconciliation']);
...
const page = () => {
    ...
    return (
        <>
            <Industries mainTitle={mainTitle} mainDescription={mainDescription} mainImg={"/retail-approval-memo-reconciliation.jpg"} mainButtonContent={mainButtonContent} section={section} section2Title={section2Title} section2Data={section2Data} section7Title={section7Title} section7Data={section7Data} />
