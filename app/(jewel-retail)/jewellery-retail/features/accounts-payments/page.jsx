...
export const metadata = generatePageMetadata(pages['/jewellery-retail/features/accounts-payments']);
...
const page = () => {
    ...
    return (
        <>
            <Industries mainTitle={mainTitle} mainDescription={mainDescription} mainImg={"/retail-accounts-payments.jpg"} mainButtonContent={mainButtonContent} section={section} section7Titlei={section7Titlei} section7Datai={section7Datai} />

            <section className="sol_acc_pay_ret_business_mission1">
                <div className="text">
