...
export const metadata = generatePageMetadata(pages['/jewellery-wholesale/industries/all-industries']);
...
const page = () => {
    return (
        <div>
            ...
            <div className="erp-whole-summary-container">
                <h1 className="erp-title">OptigoApps Jewellery Wholesaler ERP</h1>
                <p className="erp-subtitle">A complete ERP suite designed for domestic, international, and multi-branch jewellery wholesalers to manage every aspect of operations—faster, smarter, and more profitably.</p>
