...
export const metadata = generatePageMetadata(pages['/jewellery-wholesale/industries/multi-branch-wholesalers']);

const page = () => {

    const mainTitle = "Optigo ERP for Multi-Branch Wholesalers";
    const mainDescription = `<strong>Optigo</strong> ERP offers a powerful Branch Module specifically designed for multi-branch jewellery wholesalers. Now, as a wholesaler, you can expand your business to any city or country, and Optigo will centralize all operations seamlessly between your Head Office (HO) and branches.`;
    ...
    const section6Title = "Scale Smarter with Optigo’s Multi-Branch ERP";
    ...
    return (
        <>
            <Industries mainTitle={mainTitle} mainDescription={mainDescription} mainImg={'/multi-branch-wholesalers.jpg'} mainButtonContent={mainButtonContent} section={section} section7Title={section7Title} section7Data={section7Data} section6Title={section6Title} section6Description={section6Description} />
        </>
    )
}
