...
export const metadata = generatePageMetadata(pages['/jewellery-manufacture/industries']);
...
const page = () => {
    return (
        <div>
            ...
            <div className="erp-mfg-summary-container-1">
                <h1 className="erp-title-1">OptigoApps Jewellery Manufacturing ERP</h1>
                <p className="erp-subtitle-1">Complete summary solutions for managing all types of jewellery production workflows.</p>

                <div className='erp_section_main_1'>
